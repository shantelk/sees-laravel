<div class="modal nested-modal" id="luckyDrawModal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content download-modal">
            ...
            <div class="modal-body">
                <h3>Congratulations! <br> You have successfully entered the Lucky Draw.</h3>
                <p>Winners will be announced on ATLUS SEA Discord! <br> Stay tuned!</p>
                <div class="w-100">
                    <button class="btn-tertiary mt-4" data-bs-dismiss="modal" aria-label="Close">Go to Discord</button>
                </div>
            </div>
        </div>
    </div>
