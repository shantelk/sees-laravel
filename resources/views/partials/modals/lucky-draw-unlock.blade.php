<div class="modal nested-modal" id="unlockLuckyDraw" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content download-modal">
            ...
            <div class="modal-body">
                <h3>Complete all the tasks <br> to unlock Lucky Draw!</h3>
                <div class="w-100">
                    <button class="btn-tertiary mt-4" data-bs-dismiss="modal" aria-label="Close">Back to Missions</button>
                </div>
            </div>
        </div>
    </div>
